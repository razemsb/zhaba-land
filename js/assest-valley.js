document.addEventListener("DOMContentLoaded", () => {
  ...
  var data = [
    ...
    },
    {
        id: "Парки",
        name: "Парки",
        description: "Парки - это зеленые зоны для отдыха и развлечения. Они оборудованы скамейками, детскими площадками, спортивными сооружениями и другими объектами инфраструктуры. В парках можно гулять, наслаждаться природой, играть в игры, заниматься спортом, общаться с друзьями и родственниками.",
    },
    {
        id: "Фигура_9",
        name: "Фигура 9",
